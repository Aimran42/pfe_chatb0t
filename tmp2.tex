...
% Bandeaux TikZ stylisés (haut et bas)
\begin{tikzpicture}[remember picture, overlay]
  \fill[primary] (current page.north west) rectangle ([yshift=-3.5cm]current page.north east);
  \fill[accent] ([yshift=-3.5cm]current page.north west) rectangle ([yshift=-3.8cm]current page.north east);
  \fill[primary] (current page.south west) rectangle ([yshift=2.5cm]current page.south east);
  \fill[accent] ([yshift=2.5cm]current page.south west) rectangle ([yshift=2.9cm]current page.south east);
\end{tikzpicture}

% Logos dans le bandeau supérieur supérieur
\vspace*{-2.2cm}
\begin{minipage}{0.45\textwidth}
    \begin{flushleft}
        \includegraphics[height=1.8cm]{est.png}
    \end{flushleft}
\end{minipage}%
...
\begin{minipage}{0.45\textwidth}
    \begin{flushright}
        \includegraphics[height=1.8cm]{usms.png}
    \end{flushright}
\end{minipage}
...
{\centering
  ...
  \textcolor{white}{\normalsize École Supérieure de Technologie de FBS}\\[3pt]
\par}

\vspace{1.5cm}
{\centering
  \textcolor{primary}{\large\bfseries\MakeUppercase{Rapport de Projet de Fin d'Études}}\\[6pt]
  \textcolor{accent}{\small\bfseries\MakeUppercase{\diplo\ ---\ \filiere}}\\
\par}

\vspace{0.8cm}
\begin{center}
  \begin{tikzpicture}
    \node[draw=accent, line width=1.5pt, rounded corners=8pt,
          fill=lightgray, inner sep=14pt, text width=13.5cm, align=center]
    {
      \Huge\bfseries\color{primary}\titreProjet\\[0.3cm]
      \Large\color{accent}\textbf{NLP \& Architecture RAG}
    };
  \end{tikzpicture}
\end{center}

\vspace{0.8cm}
% Pipeline RAG miniature en TikZ ajusté pour la largeur de page
\begin{center}
\begin{tikzpicture}[scale=0.9, transform shape]
  \tikzstyle{box}=[draw=accent, fill=white, rounded corners=4pt,
  ...
  \node[box] (pine) at (5.6,0)  {Pinecone};
  \node[box] (rag)  at (8.4,0)  {Groq / Llama};
  \node[box] (user) at (11.2,0) {Interface Web};
...
\begin{center}
  ...
  \begin{tabular}{p{5cm}l}
    \textcolor{primary}{\bfseries Réalisé par :} & Boubker Abderrahmane \\
                                                 & Mahdam Mohammed Amine \\[0.4cm]
    \textcolor{primary}{\bfseries Encadré par :}  & Pr. Rachid Ait Daoud \\[0.4cm]
    \textcolor{primary}{\bfseries Domaine :}      & Intelligence Artificielle \& NLP \\
  \end{tabular}
\end{center}

\vfill
\begin{center}
  \textcolor{primary}{\bfseries ANNÉE UNIVERSITAIRE : 2025 -- 2026}\\[0.4cm]
  \textcolor{white}{\footnotesize Email: estfbs@usms.ma
 Site Web: http:// estfbs.usms.ac.ma/}
\end{center}
\end{titlepage}
